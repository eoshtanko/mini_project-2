...
// (так как всего предложенно 22 задачи)

// 5. Задача о каннибалах.
// Племя из n дикарей ест вместе из большого горшка, который вмещает m кусков тушеного миссионера.
...
// Создать многопоточное приложение, моделирующее обед дикарей.
